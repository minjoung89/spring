...
<form method="post" action="/spring/member/modifyPro.nhn" name="userinput" onsubmit="return checkIt()">
   ...
   <tr> 
    ...
    <tr> 
      <td colspan="2" align="center" bgcolor="<%=value_c%>"> 
       ...
       <input type="button" value="취  소" onclick="javascript:window.location='/spring/member/main.nhn'">      
      </td>
    </tr>
  </table>
</form>
